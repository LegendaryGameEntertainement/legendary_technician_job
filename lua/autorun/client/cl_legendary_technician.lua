...
net.Receive("legendary_technician_repair", function()
...
net.Receive("legendary_technician_togglehud", function()
    local shouldBeActive = net.ReadBool()
    if shouldBeActive then
        hook.Add("HUDPaint", "legendary_technician_hud",legendaryTechnicianHUD)
    else
        hook.Remove("HUDPaint", "legendary_technician_hud")
    end
end)

function legendaryTechnicianHUD()
    ...
    for _, ent in ipairs( ents.FindByClass( "legendary_tec*" ) ) do
...
print("[legendary_technician] cl loaded")
